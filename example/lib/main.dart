...
import 'package:ffigen_app_example/duktape_message.dart';
...
class _DuktapeReplState extends ConsumerState<DuktapeRepl> {
  ...
  void _handleSubmitted(String text) {
    ...
    setState(() {
      ref.read(duktapeMessageProvider.notifier).eval(text);
    });
  ...
  @override
  Widget build(BuildContext context) {
    final messages = ref.watch(duktapeMessageProvider);
    return Scaffold(
